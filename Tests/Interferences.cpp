...
TEST(fan_test, fan_to_interference){
    EXPECT_EQ(conversions::fanToInterference(communication::messages::types::FanType::GOBLIN), gameModel::InterferenceType::RangedAttack);
    EXPECT_EQ(conversions::fanToInterference(communication::messages::types::FanType::TROLL), gameModel::InterferenceType::Impulse);
    EXPECT_EQ(conversions::fanToInterference(communication::messages::types::FanType::ELF), gameModel::InterferenceType::Teleport);
    EXPECT_EQ(conversions::fanToInterference(communication::messages::types::FanType::NIFFLER), gameModel::InterferenceType::SnitchPush);
}

TEST(fan_test, interference_to_fan) {
    EXPECT_EQ(conversions::interferenceToFan(gameModel::InterferenceType::RangedAttack), communication::messages::types::FanType::GOBLIN);
    EXPECT_EQ(conversions::interferenceToFan(gameModel::InterferenceType::Teleport), communication::messages::types::FanType::ELF);
    EXPECT_EQ(conversions::interferenceToFan(gameModel::InterferenceType::Impulse), communication::messages::types::FanType::TROLL);
    EXPECT_EQ(conversions::interferenceToFan(gameModel::InterferenceType::SnitchPush), communication::messages::types::FanType::NIFFLER);
}